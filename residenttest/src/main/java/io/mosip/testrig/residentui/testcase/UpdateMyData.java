...
public class UpdateMyData extends BaseClass {
	...
	public void updateMyData() throws Exception {
		...
		Commons.enter(test,driver, By.id("fileDropRef"), System.getProperty("user.dir")+"\\BulkUploadFiles\\tonyId.png");
		...
		Commons.enter(test,driver, By.id("fileAddRef"), System.getProperty("user.dir")+"\\BulkUploadFiles\\tonyId.png");
		...
		Commons.click(test,driver, By.id("sendOTPemail"));
...
//		    Commons.enter(driver, By.xpath("//*[@class=\"pincode-input-text\"]["+(i+1)+"]"), Character.toString(otp.charAt(i)));}
		    ...
		    Commons.click(test,driver, By.xpath("(//button[@class='button mat-button'])[2]"));
		    Commons.click(test,driver, By.id("confirmmessagepopup"));
...
//		
     ...
     public void UpdateDataWithNameAndDOB() throws Exception {
    	 ...
    	 test=extent.createTest("UpdateDataWithNameAndDOB ", "verify Login");
	      Commons.click(test,driver, By.xpath("(//mat-card[@class='mini-card mat-card'])[7]"));
	      Commons.enter(test,driver, By.id("fullName"), data);
	      Commons.click(test,driver, By.id("dateOfBirth"));
	      Commons.click(test,driver, By.xpath("//*[@id=\"mat-datepicker-0\"]/mat-calendar-header/div/div/button[2]"));
		  Commons.click(test,driver, By.xpath("//*[@id=\"mat-datepicker-0\"]/div/mat-month-view/table/tbody/tr[4]/td[6]/div"));
		  Commons.dropdown(test,driver, By.id("proofOfIdentity"));
